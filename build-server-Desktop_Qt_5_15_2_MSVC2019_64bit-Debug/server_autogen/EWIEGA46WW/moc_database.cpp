...
QT_MOC_LITERAL(1, 9, 7), // "dropAll"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 14), // "inserIntoTable"
QT_MOC_LITERAL(4, 33, 14), // "QVector<Block>"
QT_MOC_LITERAL(5, 48, 6), // "blocks"
QT_MOC_LITERAL(6, 55, 10) // "fetch_data"

    },
    "DataBase\0dropAll\0\0inserIntoTable\0"
    "QVector<Block>\0blocks\0fetch_data"
};
...
void DataBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dropAll(); break;
        case 1: { bool _r = _t->inserIntoTable((*reinterpret_cast< const QVector<Block>(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 2: { QVector<Block> _r = _t->fetch_data();
            if (_a[0]) *reinterpret_cast< QVector<Block>*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
}
